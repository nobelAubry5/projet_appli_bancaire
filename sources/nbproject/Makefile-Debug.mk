...
${TESTDIR}/tests/ChequeTesteur.o: tests/ChequeTesteur.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ChequeTesteur.o tests/ChequeTesteur.cpp


${TESTDIR}/tests/ClientTesteur.o: tests/ClientTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ClientTesteur.o tests/ClientTesteur.cpp


${TESTDIR}/tests/CompteTesteur.o: tests/CompteTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/CompteTesteur.o tests/CompteTesteur.cpp


${TESTDIR}/tests/EpargneTesteur.o: tests/EpargneTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/usr/src/gtest/include -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/EpargneTesteur.o tests/EpargneTesteur.cpp
